...
class FinalizeContentWidget extends StatelessWidget {
      ...
      children: [
              ...
              children: [
                TextSpan(
                  text: localization.translate(
                    LanguageKey.finalizeScreenAddTitle,
                  ),
                ...
                TextSpan(
                  text: ' (${localization.translate(
                    LanguageKey.finalizeScreenOptional,
                  )})',
          ...
          labelWidget: FlexibleDualWidgetRow(
            ...
            firstChildWidget: Text(
              localization.translate(
                LanguageKey.finalizeScreenShowPrompt,
              ),
              style: AppTypography.heading5Bold.copyWith(
                color: appTheme.greyScaleColor900,
              ),
        ...
        TextBoxWithLabel(
          ...
          labelWidget: FlexibleDualWidgetRow(
            ...
            firstChildWidget: Text(
              localization.translate(
                LanguageKey.finalizeScreenShowNegativePrompt,
              ),
              style: AppTypography.heading5Bold.copyWith(
                color: appTheme.greyScaleColor900,
              ),
        ...
        TextBoxWithLabel(
          ...
          labelWidget: FlexibleDualWidgetRow(
            ...
            firstChildWidget: Text(
              localization.translate(
                LanguageKey.finalizeScreenShowCFGScale,
              ),
              style: AppTypography.heading5Bold.copyWith(
                color: appTheme.greyScaleColor900,
              ),
        ...
        TextBoxWithLabel(
          ...
          labelWidget: FlexibleDualWidgetRow(
            ...
            firstChildWidget: Text(
              localization.translate(
                LanguageKey.finalizeScreenShowSeed,
              ),
              style: AppTypography.heading5Bold.copyWith(
                color: appTheme.greyScaleColor900,
              ),
