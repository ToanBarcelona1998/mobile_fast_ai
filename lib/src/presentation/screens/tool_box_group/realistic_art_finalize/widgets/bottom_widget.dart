...
class RealisticArtFinalizeBottomWidget extends StatelessWidget {
  final AppTheme appTheme;
  final AppLocalizationManager localization;
  final VoidCallback onDownloadArt;
  final VoidCallback onShareToFeed;

  const RealisticArtFinalizeBottomWidget({
          ...
          child: Row(
            children: [
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.realisticArtFinalizeScreenDownloadArt,
                  ),
              ...
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.realisticArtFinalizeScreenShareToFeed,
                  ),
