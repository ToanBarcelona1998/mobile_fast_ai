...
class ImageToPaintingEditArtWorkGenerateImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  ...
  const ImageToPaintingEditArtWorkGenerateImageWidget({
    this.loading = true,
    required this.url,
              ...
              children: [
                ...
                Text(
                  localization.translate(
                    LanguageKey.imageToPaintingEditArtWorkScreenGenerating,
                  ),
...
class ImageToPaintingEditArtWorkBoxImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  final AppTheme appTheme;
  final AppLocalizationManager localization;

  const ImageToPaintingEditArtWorkBoxImageWidget({
    this.loading = true,
    required this.url,
    required this.localization,
    required this.appTheme,
