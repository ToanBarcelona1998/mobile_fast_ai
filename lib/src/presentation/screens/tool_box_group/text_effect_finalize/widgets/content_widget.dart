...
class TextEffectFinalizeContentWidget extends StatelessWidget {
  final AppLocalizationManager localization;
  final AppTheme appTheme;
  final String title;

  const TextEffectFinalizeContentWidget({
    required this.title,
          ...
          children: [
            TextSpan(
              text: localization.translate(
                LanguageKey.textEffectFinalizeScreenAddTitle,
              ),
            ...
            TextSpan(
              text: ' (${localization.translate(
                LanguageKey.textEffectFinalizeScreenOptional,
              )})',
