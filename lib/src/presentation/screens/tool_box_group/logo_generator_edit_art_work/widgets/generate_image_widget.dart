...
class LogoGeneratorEditArtWorkGenerateImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  ...
  const LogoGeneratorEditArtWorkGenerateImageWidget({
    this.loading = true,
    required this.url,
...
class LogoGeneratorEditArtWorkBoxImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  final AppTheme appTheme;
  final AppLocalizationManager localization;

  const LogoGeneratorEditArtWorkBoxImageWidget({
    this.loading = true,
    required this.url,
    required this.localization,
    required this.appTheme,
