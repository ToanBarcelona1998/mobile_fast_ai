...
class LogoGeneratorEditArtWorkRatioWidget extends StatelessWidget {
  final AppTheme appTheme;
  final AppLocalizationManager localization;
  final VoidCallback onTap;

  const LogoGeneratorEditArtWorkRatioWidget({
      ...
      children: [
        TextWithIconWidget(
          title: localization.translate(
            LanguageKey.logoGeneratorEditArtWorkScreenRatio,
          ),
          appTheme: appTheme,
