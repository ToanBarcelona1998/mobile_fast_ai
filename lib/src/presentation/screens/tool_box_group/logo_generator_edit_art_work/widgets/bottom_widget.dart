...
class LogoGeneratorEditArtWorkBottomWidget extends StatelessWidget {
  final AppLocalizationManager localization;
  final AppTheme appTheme;
  final VoidCallback onReGenerateTap;
  final VoidCallback onDownloadAllTap;

  const LogoGeneratorEditArtWorkBottomWidget({
          ...
          child: Row(
            children: [
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.logoGeneratorEditArtWorkScreenReGenerate,
                  ),
              ...
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.logoGeneratorEditArtWorkScreenDownload,
                  ),
