...
class ControlNetEditArtWorkGenerateImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  ...
  const ControlNetEditArtWorkGenerateImageWidget({
    this.loading = true,
    required this.url,
...
class ControlNetEditArtWorkBoxImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  final AppTheme appTheme;
  final AppLocalizationManager localization;

  const ControlNetEditArtWorkBoxImageWidget({
    this.loading = true,
    required this.url,
    required this.localization,
    required this.appTheme,
