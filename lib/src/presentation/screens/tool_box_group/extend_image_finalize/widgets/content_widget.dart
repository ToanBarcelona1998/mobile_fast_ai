...
class ExtendImageFinalizeContentWidget extends StatelessWidget {
  final AppLocalizationManager localization;
  final AppTheme appTheme;
  final String title;

  const ExtendImageFinalizeContentWidget({
    required this.title,
          ...
          children: [
            TextSpan(
              text: localization.translate(
                LanguageKey.extendImageFinalizeScreenAddTitle,
              ),
            ...
            TextSpan(
              text: ' (${localization.translate(
                LanguageKey.extendImageFinalizeScreenOptional,
              )})',
