...
class PhotoToAnimeEditArtWorkGenerateImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  ...
  const PhotoToAnimeEditArtWorkGenerateImageWidget({
    this.loading = true,
    required this.url,
              ...
              children: [
                ...
                Text(
                  localization.translate(
                    LanguageKey.photoToAnimeEditArtWorkScreenGenerating,
                  ),
...
class PhotoToAnimeEditArtWorkBoxImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  final AppTheme appTheme;
  final AppLocalizationManager localization;

  const PhotoToAnimeEditArtWorkBoxImageWidget({
    this.loading = true,
    required this.url,
    required this.localization,
    required this.appTheme,
