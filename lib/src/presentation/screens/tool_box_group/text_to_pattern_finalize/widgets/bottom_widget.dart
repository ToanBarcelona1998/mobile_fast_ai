...
class TextToPatternFinalizeBottomWidget extends StatelessWidget {
  final AppTheme appTheme;
  final AppLocalizationManager localization;
  final VoidCallback onDownloadArt;
  final VoidCallback onShareToFeed;

  const TextToPatternFinalizeBottomWidget({
          ...
          child: Row(
            children: [
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.textToPatternFinalizeScreenDownloadArt,
                  ),
              ...
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.textToPatternFinalizeScreenShareToFeed,
                  ),
