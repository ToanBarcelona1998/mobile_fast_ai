...
class BatchArtGeneratorFinalizeContentWidget extends StatelessWidget {
  final AppLocalizationManager localization;
  final AppTheme appTheme;
  final String title;

  const BatchArtGeneratorFinalizeContentWidget({
    required this.title,
          ...
          children: [
            TextSpan(
              text: localization.translate(
                LanguageKey.batchArtGeneratorFinalizeScreenAddTitle,
              ),
            ...
            TextSpan(
              text: ' (${localization.translate(
                LanguageKey.batchArtGeneratorFinalizeScreenOptional,
              )})',
