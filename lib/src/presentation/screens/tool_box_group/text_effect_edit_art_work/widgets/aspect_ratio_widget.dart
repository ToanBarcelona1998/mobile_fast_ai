...
class TextEffectEditArtWorkRatioWidget extends StatelessWidget {
  final AppTheme appTheme;
  final AppLocalizationManager localization;
  final VoidCallback onTap;

  const TextEffectEditArtWorkRatioWidget({
      ...
      children: [
        TextWithIconWidget(
          title: localization.translate(
            LanguageKey.textEffectEditArtWorkScreenAspectRatio,
          ),
          appTheme: appTheme,
