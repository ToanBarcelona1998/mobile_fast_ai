...
class BatchArtGeneratorInputImagesWidget extends StatelessWidget {
  final AppTheme appTheme;
  final AppLocalizationManager localization;

  const BatchArtGeneratorInputImagesWidget({
              ...
              children: [
                TextSpan(
                  text: localization.translate(
                    LanguageKey.batchArtGeneratorScreenInputImages,
                  ),
                ...
                TextSpan(
                  text: ' (${localization.translate(
                    LanguageKey.batchArtGeneratorScreenOptional,
                  )})',
            ...
            children: [
              UploadMultiImageWidget(
                ...
                label: localization.translate(
                  LanguageKey.batchArtGeneratorScreenUpload,
                ),
