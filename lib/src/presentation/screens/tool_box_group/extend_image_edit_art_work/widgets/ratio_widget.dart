...
class ExtendImageEditArtWorkRatioWidget extends StatelessWidget {
  final AppTheme appTheme;
  final AppLocalizationManager localization;
  final TextEditingController widthController;
  final TextEditingController heightController;

  const ExtendImageEditArtWorkRatioWidget({
      ...
      children: [
        Text(
          localization.translate(
            LanguageKey.extendImageEditArtWorkScreenExtendRatio,
          ),
          ...
          firstChildWidget: Expanded(
            child: NormalTextInputWidget(
              ...
              hintText: localization.translate(
                LanguageKey.extendImageEditArtWorkScreenExtendWidth,
              ),
              maxLine: 1,
              keyBoardType: TextInputType.number,
              suffix: Text(
                localization.translate(
                  LanguageKey.extendImageEditArtWorkScreenPx,
                ),
