...
class RealisticArtEditArtWorkGenerateImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  ...
  const RealisticArtEditArtWorkGenerateImageWidget({
    this.loading = true,
    required this.url,
              ...
              children: [
                ...
                Text(
                  localization.translate(
                    LanguageKey.realisticArtEditArtWorkScreenGenerating,
                  ),
...
class RealisticEditArtWorkBoxImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  final AppTheme appTheme;
  final AppLocalizationManager localization;

  const RealisticEditArtWorkBoxImageWidget({
    this.loading = true,
    required this.url,
    required this.localization,
    required this.appTheme,
