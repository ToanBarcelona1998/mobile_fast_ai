...
class BatchArtGeneratorListBottomWidget extends StatelessWidget {
  final AppLocalizationManager localization;
  final AppTheme appTheme;
  final VoidCallback onReGenerateTap;
  final VoidCallback onDownloadAllTap;

  const BatchArtGeneratorListBottomWidget({
          ...
          child: Row(
            children: [
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.batchArtGeneratorListScreenReGenerate,
                  ),
              ...
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.batchArtGeneratorListScreenDownloadAll,
                  ),
