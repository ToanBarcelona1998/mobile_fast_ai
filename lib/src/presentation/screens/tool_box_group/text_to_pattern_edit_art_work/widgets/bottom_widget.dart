...
class TextToPatternEditArtWorkBottomWidget extends StatelessWidget {
  final AppLocalizationManager localization;
  final AppTheme appTheme;
  final VoidCallback onReGenerateTap;
  final VoidCallback onDownloadAllTap;

  const TextToPatternEditArtWorkBottomWidget({
          ...
          child: Row(
            children: [
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.textToPatternEditArtWorkScreenReGenerate,
                  ),
              ...
              Expanded(
                child: PrimaryAppButton(
                  text: localization.translate(
                    LanguageKey.textToPatternEditArtWorkScreenDownload,
                  ),
