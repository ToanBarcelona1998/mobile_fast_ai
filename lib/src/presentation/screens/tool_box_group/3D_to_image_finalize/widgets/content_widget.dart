...
class ThreeDToImageFinalizeContentWidget extends StatelessWidget {
  final AppLocalizationManager localization;
  final AppTheme appTheme;
  final String title;

  const ThreeDToImageFinalizeContentWidget({
    required this.title,
          ...
          children: [
            TextSpan(
              text: localization.translate(
                LanguageKey.threeDToImageFinalizeScreenAddTitle,
              ),
            ...
            TextSpan(
              text: ' (${localization.translate(
                LanguageKey.threeDToImageFinalizeScreenOptional,
              )})',
