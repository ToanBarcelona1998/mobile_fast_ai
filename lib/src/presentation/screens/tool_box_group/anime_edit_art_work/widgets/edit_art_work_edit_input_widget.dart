...
class EditARtWorkEditInputWidget extends AppBottomSheetProviderWidget {
        ...
        Row(
          children: [
            Expanded(
              child: PrimaryAppButton(
                text: localization.translate(
                  LanguageKey.animeEditArtWorkScreenCancel,
                ),
            ...
            Expanded(
              child: PrimaryAppButton(
                text: localization.translate(
                  LanguageKey.animeEditArtWorkScreenSave,
                ),
              ),
            ),
          ],
      ...
      children: [
        TextInputWithBoxFormWidget(
          label: localization.translate(
            LanguageKey.animeEditArtWorkScreenEditPrompt,
          ),
        ),
        const SizedBox(
          height: BoxSize.boxSize05,
        ...
        TextInputWithBoxFormWidget(
          label: localization.translate(
            LanguageKey.animeEditArtWorkScreenAddNegativePrompt,
          ),
        ),
        const SizedBox(
          height: BoxSize.boxSize05,
        ...
        TextInputWithBoxFormWidget(
          label: localization.translate(
            LanguageKey.animeEditArtWorkScreenSeed,
          ),
        ),
        const SizedBox(
          height: BoxSize.boxSize05,
        ...
        Text(
          localization.translate(
            LanguageKey.animeEditArtWorkScreenAspectRatio,
          ),
        ...
        Text(
          localization.translate(
            LanguageKey.animeEditArtWorkScreenCFGScale,
          ),
          style: AppTypography.heading5Bold.copyWith(
            color: appTheme.greyScaleColor900,
          ),
  ...
  Widget? titleBuilder(BuildContext context, AppTheme appTheme) {
    return Text(
      localization.translate(
        LanguageKey.animeEditArtWorkScreenEditInput,
      ),
