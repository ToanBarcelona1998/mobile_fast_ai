...
class SketchToImageEditArtWorkGenerateImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  ...
  const SketchToImageEditArtWorkGenerateImageWidget({
    this.loading = true,
    required this.url,
              ...
              children: [
                ...
                Text(
                  localization.translate(
                    LanguageKey.sketchToImageEditArtWorkScreenGenerating,
                  ),
...
class SketchToImageEditArtWorkBoxImageWidget extends StatelessWidget {
  final bool loading;
  final String url;
  final AppTheme appTheme;
  final AppLocalizationManager localization;

  const SketchToImageEditArtWorkBoxImageWidget({
    this.loading = true,
    required this.url,
    required this.localization,
    required this.appTheme,
